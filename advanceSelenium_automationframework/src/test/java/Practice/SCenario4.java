...
public class SCenario4 {
	...
	public static void main(String[] args) throws FileNotFoundException,InterruptedException, EncryptedDocumentException, IOException {
		...
		FileInputStream fise = new FileInputStream(".\\src\\test\\resources\\Book1.xlsx");
		...
		//Step 2: Launch the Browser // Run Time Polymorphism - driver
				...
				//Step 6: create organization with industry and Type
